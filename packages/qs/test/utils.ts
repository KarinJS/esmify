...
test('decode', function (t) {
  ...
  t.equal(
    utils.decode('name%2Eobj%2Efoo', undefined, 'iso-8859-1'),
    'name.obj.foo',
...
test('encode', function (t) {
  ...
  t.equal(
    utils.encode('abc 123 💩', undefined, 'iso-8859-1'),
  ...
  t.equal(
    utils.encode('\x28\x29', undefined, undefined, undefined, 'RFC1738'),
    '()',
...
test('isBuffer()', function (t) {
  ...
  const saferBuffer = SaferBuffer.Buffer.from('abc')
  t.equal(utils.isBuffer(saferBuffer), true, 'SaferBuffer instance is a buffer')

  const buffer = (typeof Buffer.from === 'function' && typeof Buffer.alloc === 'function') ? Buffer.from('abc') : new Buffer('abc')
